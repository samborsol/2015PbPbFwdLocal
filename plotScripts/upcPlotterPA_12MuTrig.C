...
void upcPlotterPA_12MuTrig(){
	...
	t->Draw("hiHFminus >> h1",trig1);
	t->Draw("hiHFminus >> h2",trig2);
	t->Draw("hiHFminus >> h3",trig3);
	t->Draw("hiHFminus >> h4",trig4);
	t->Draw("hiHFminus >> h5",trig5);
	t->Draw("hiHFminus >> h6",trig6);
