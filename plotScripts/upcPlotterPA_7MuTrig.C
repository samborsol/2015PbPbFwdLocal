...
void upcPlotterPA_7MuTrig(){
	...
	t->Draw("Di_mass >> h1",trig1+ptCut+rapCut);
	t->Draw("Di_mass >> h2",trig2+ptCut+rapCut);
	//t->Draw("Di_mass >> h3",trig3+ptCut+rapCut);
	//t->Draw("Di_mass >> h4",trig4+ptCut+rapCut);
	//t->Draw("Di_mass >> h5",trig5+ptCut+rapCut);
	//t->Draw("Di_mass >> h6",trig6+ptCut+rapCut);
