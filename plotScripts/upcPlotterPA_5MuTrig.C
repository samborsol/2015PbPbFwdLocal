...
void upcPlotterPA_5MuTrig(){
	...
	t->Draw("Di_mass >> h2",trig2+rapCut+ptCut);
	t->Draw("Di_mass >> h3",trig3+rapCut+ptCut);
	t->Draw("Di_mass >> h4",trig4+rapCut+ptCut);
	t->Draw("Di_mass >> h5",trig5+rapCut+ptCut);
	t->Draw("Di_mass >> h6",trig6+rapCut+ptCut);
